    ...
    <div class="buttons">
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                ...
                <asp:Button ID="btnSendMail" runat="server" Text="Email Inpection Deficiencies" OnClick="btnSendMail_Click" Height="38px" Width="250px" Visible="false" OnClick="btnSendMail_Click" />
