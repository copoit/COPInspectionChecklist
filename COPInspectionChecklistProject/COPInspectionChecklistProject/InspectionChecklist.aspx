...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="Inspection Report">
        <asp:Table ID="HousingInspectionReport" runat="server" Width="960px" BorderStyle="Solid" BorderWidth="3px" BorderColor="Black" CellPadding="1" CellSpacing="1" HorizontalAlign="Left">
            ...
            <asp:TableRow BorderStyle="Solid" HorizontalAlign="Left" VerticalAlign="Top">
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtCaseNum" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow BorderStyle="Solid" HorizontalAlign="Left" VerticalAlign="Top">
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtPropAdd" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow BorderStyle="Solid" HorizontalAlign="Left" VerticalAlign="Top">
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtDwellInfo" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow BorderStyle="Solid" HorizontalAlign="Left" VerticalAlign="Top">
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtApplicant" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow BorderStyle="Solid" HorizontalAlign="Left" VerticalAlign="Top">
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtAppPhone" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow BorderStyle="Solid" HorizontalAlign="Left" VerticalAlign="Top">
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtAppEmail" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow BorderStyle="Solid" HorizontalAlign="Left" VerticalAlign="Top">
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtInspectName" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow BorderStyle="Solid" HorizontalAlign="Left" VerticalAlign="Top">
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtInspectEmail" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow BorderStyle="Solid" HorizontalAlign="Left" VerticalAlign="Top">
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtInspectDate" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow BorderStyle="Solid" HorizontalAlign="Left" VerticalAlign="Top">
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtInspectType" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow BorderStyle="Solid" HorizontalAlign="Left" VerticalAlign="Top">
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtMailAdd" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow BorderStyle="Solid" HorizontalAlign="Left" VerticalAlign="Top">
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtNumUnit" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow BorderStyle="Solid" HorizontalAlign="Left" VerticalAlign="Top">
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtOwnerPhone" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow BorderStyle="Solid" HorizontalAlign="Left" VerticalAlign="Top">
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtSidewalk" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </div>
    <div class="InspectionBreakdown">
        <asp:Table ID="NoticeTable1" runat="server" Width="960px" BorderStyle="Solid" BorderWidth="3px" CellPadding="1" CellSpacing="1" HorizontalAlign="Left" BorderColor="Black">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Table ID="InspectionFindingsTable" runat="server" Width="960px" BorderStyle="Solid" BorderWidth="3px" CellPadding="1" CellSpacing="1" HorizontalAlign="Left" BorderColor="Black">
                <asp:TableHeaderRow BorderStyle="Solid" VerticalAlign="Middle" ID="headin2">
                ...
                <asp:TableRow VerticalAlign="Middle">
                    ...
                    <asp:TableCell ><asp:CheckBox ID="cBMajor" runat="server" Style="padding-left: 30px;" Text="" Font-Names="Arial Black" TextAlign="Right" OnCheckedChanged="cBMajor_CheckedChanged" AutoPostBack="true" /></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow VerticalAlign="Middle">
                    ...
                    <asp:TableCell ><asp:CheckBox ID="cBMinor" runat="server" Style="padding-left: 30px;" Text="" Font-Names="Arial Black" TextAlign="Right" OnCheckedChanged="cBMinor_CheckedChanged" AutoPostBack="true" /></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow VerticalAlign="Middle">
                    ...
                    <asp:TableCell ><asp:CheckBox ID="cBNoMajor" runat="server" Style="padding-left: 30px;" Text="" Font-Names="Arial Black" TextAlign="Right" OnCheckedChanged="cBMajor_CheckedChanged" AutoPostBack="true" /></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow VerticalAlign="Middle">
                    ...
                    <asp:TableCell ><asp:CheckBox ID="cBNoMinor" runat="server" Style="padding-left: 30px;" Text="" Font-Names="Arial Black" TextAlign="Right" OnCheckedChanged="cBNoMinor_CheckedChanged" AutoPostBack="true" /></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow VerticalAlign="Middle">
                    <asp:TableCell HorizontalAlign="Left" VerticalAlign="Middle" Width="50%">NO VIOLATIONS WERE OBSERVED</asp:TableCell>
                    <asp:TableCell ><asp:CheckBox ID="cBNoViolations" runat="server" Style="padding-left: 30px;" Text="" Font-Names="Arial Black" TextAlign="Right" OnCheckedChanged="cBNoViolations_CheckedChanged" AutoPostBack="true" /></asp:TableCell>
                </asp:TableRow>
            </asp:Table>
        </ContentTemplate>
    </asp:UpdatePanel>
