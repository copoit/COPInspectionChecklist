    ...
    <div class="Inspection Report">
        ...
        <asp:Table ID="CaseMainTable" runat="server" Width="960px">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtRespParty" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtOccDwell" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell Width="20%">Number of Units:</asp:TableCell>
                <asp:TableCell>
                    <asp:TextBox ID="txtNumUnits" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell Width="20%">Owner Name:</asp:TableCell>
                <asp:TableCell>
                    <asp:TextBox ID="txtOwnerName" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtInspector" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtReinspectDate" runat="server" Width="100%"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </div>
    <br />
